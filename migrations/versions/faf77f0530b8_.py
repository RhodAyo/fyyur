...
Revision ID: faf77f0530b8
Revises: cb4e5c9ca000
Create Date: 2022-06-02 17:31:14.103250
...
revision = 'faf77f0530b8'
down_revision = 'cb4e5c9ca000'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('genre', sa.ARRAY(sa.String(length=70)), nullable=False),
    ...
    sa.Column('phone', sa.String(length=120), nullable=True),
    sa.Column('genre', sa.ARRAY(sa.String(length=70)), nullable=True),
    sa.Column('image_link', sa.String(length=500), nullable=True),
    sa.Column('facebook_link', sa.String(length=120), nullable=True),
    sa.Column('website_link', sa.String(length=120), nullable=True),
